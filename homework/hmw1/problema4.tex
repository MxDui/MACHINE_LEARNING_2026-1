...
\begin{enumerate}
    ...
    \textbf{Justificación para la función suave:}
    
    Las funciones indicadoras binarias presentan limitaciones importantes:
    \begin{itemize}
    ...
    \textbf{Propuesta de función de pérdida relajada:}
    
    Mi función de pérdida relajada $L_{\text{soft}}: \mathbb{R}^2 \rightarrow [0, 1]$ satisface:
    \begin{enumerate}
    ...
    \textbf{Concepto de zona de transición}
    ...
    \textbf{Parametrización alternativa usando distancia euclidiana}
    ...
    \textbf{Principio de penalización gradual}
    ...
    \textbf{Definición completa de la función relajada}
    ...
    \textbf{Familia de funciones relajadas}
    ...
    \textbf{Análisis de la superficie de pérdida}
