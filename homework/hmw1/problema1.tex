...
def indicator_triangle(x, y, theta):
    ...
    Para cualquier conjunto de 8 puntos en posición general, existe al menos un etiquetado no realizable por un triángulo. Idea clave: el interior de un triángulo es un conjunto \emph{convexo} con frontera poligonal de 3 lados.
    
    \begin{itemize}
        \item Si cuatro puntos forman un cuadrilátero convexo con otros cuatro en su interior, el etiquetado que marca como positivos solo a los cuatro interiores exige una región positiva \emph{no convexa} (o con frontera con más de 3 lados) para excluir los vértices exteriores, lo cual no puede implementarse con un triángulo.
        \item Más generalmente, hay etiquetados que requieren una región positiva con frontera con más de tres “giros” (número de cambios en la curvatura), imposible con una frontera triangular.
    \end{itemize}
